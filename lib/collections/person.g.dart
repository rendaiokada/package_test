...
Person _personDeserializeNative(
  Id id,
...
Object _personSerializeWeb(IsarCollection<Person> collection, Person object) {
  /*final jsObj = IsarNative.newJsObject();*/ throw UnimplementedError();
}

Person _personDeserializeWeb(IsarCollection<Person> collection, Object jsObj) {
  /*final object = Person();object.age = IsarNative.jsObjectGet(jsObj, r'age') ?? (double.negativeInfinity as int);object.firstName = IsarNative.jsObjectGet(jsObj, r'firstName') ?? '';object.id = IsarNative.jsObjectGet(jsObj, r'id') ?? (double.negativeInfinity as int);object.lastName = IsarNative.jsObjectGet(jsObj, r'lastName') ?? '';*/
  //return object;
